Feature: AddInvoiceWithTwoRate
	In order to avoid silly mistakes
	I want to add a new invoice with one rate

@mytag
Scenario: Add a new invoice with two rate successfully
	...
	| abcd    | 10/10/2020 | 10/01/2020     | 100          | invoice description | dev line desc      | 140         | 120       | credit description | 140        | 230       | 200          | non dev line des | 200          | 2000         | 2000             | 20					   | 2                      |
